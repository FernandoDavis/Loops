...
public class StudentRecordSystemTest {
	...
	public void maxTest() {
		...
		assertFalse("Max GPA is incorrect, it should be " + studentRecordSystem.getStudentRecords()[2].getGPA() + " but it was " + studentRecordSystem.maxStudentGPA(),
				studentRecordSystem.getStudentRecords()[2].getGPA() != studentRecordSystem.maxStudentGPA());
		...
		assertTrue("Max GPA correct, it should be " + studentRecordSystem.getStudentRecords()[3].getGPA() + " but it was " + studentRecordSystem.maxStudentGPA(),
				studentRecordSystem.getStudentRecords()[3].getGPA() == studentRecordSystem.maxStudentGPA());
	}
	...
	public void minTest() {
		...
		assertFalse("Min GPA is incorrect, it should be " + studentRecordSystem.getStudentRecords()[0].getGPA() + " but it was " + studentRecordSystem.minStudentGPA(),
				studentRecordSystem.getStudentRecords()[0].getGPA() != studentRecordSystem.minStudentGPA());
		...
		assertTrue("Min GPA correct, it should be " + studentRecordSystem.getStudentRecords()[4].getGPA() + " but it was " + studentRecordSystem.minStudentGPA(),
				studentRecordSystem.getStudentRecords()[4].getGPA() == studentRecordSystem.minStudentGPA());
	}
